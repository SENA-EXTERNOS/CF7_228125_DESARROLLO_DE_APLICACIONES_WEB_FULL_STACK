...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-11
        .bloque-texto-g.img-inv.color-acento-botones.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto.p-4(data-aos="fade-left")
            p Para comenzar, debemos tener claro que la conexión en terminales o estaciones de trabajo entre sí es fundamental para que las empresas o las personas lleven a cabo comunicaciones. Un ejemplo de una gran conexión de conexiones es el internet (del que luego hablaremos).<br><br>
    ...
    .BG01.p-4.mb-5
      LineaTiempoC.color-primario(text-small)
        .row(titulo="Dispositivos de red")
          ...
          .col-md-6
            p Se refiere a las terminales de trabajo como servidores, computadoras convencionales, tabletas, móviles, teléfonos IP, etc.; al igual que aparatos que logran conexión con estos como son: #[i routers, switches, hubs, firewalls], etc.
            .row
              .col-auto
    ...
    p Ahora, en los medios de comunicación, es importante tener en cuenta la velocidad y frecuencia de conexión con cables UTP dependen de algunas categorías que se detallan en la siguiente tabla:

    .titulo-sexto.color-acento-botones(data-aos="fade-right")
      h5 Tabla 1.
      span Velocidad y frecuencia de conexión
      ...
      .col-lg-7.order-lg-1.order-2(data-aos="fade-right")
        TabsA.color-acento-botones.mb-5
          .BGR04.p-4(titulo="El modelo OSI")
            h4 El modelo OSI
            p El Modelo OSI (Interconexión de Sistemas Abiertos) se encuentra dentro de los #[strong modelos de referencia]: son abstracciones para facilitar la comprensión de los protocolos de comunicación y la arquitectura de los sistemas utilizados para interrelacionar distintos programas y equipos.
            p.mb-0 Es un modelo propuesto por la Organización Internacional de Estándares (ISO) como un primer paso hacia la estandarización internacional de los protocolos utilizados en varias capas.
    ...
    .titulo-sexto.color-acento-contenido(data-aos="fade-right")
      h5 Figura 3.
      span  Capas de los modelos OSI y TCP/IP
